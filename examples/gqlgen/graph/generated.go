...
type ComplexityRoot struct {
	...
	Query struct {
		Todos func(childComplexity int, input *model.TodoInput) int
	}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.todos":
		...
		return e.complexity.Query.Todos(childComplexity, args["input"].(*model.TodoInput)), true
...
func (ec *executionContext) field_Query_todos_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_todos_argsInput(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Query_todos_argsInput(
	ctx context.Context,
	rawArgs map[string]any,
) (*model.TodoInput, error) {
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalOTodoInput2ᚖexamplesᚋgqlgenᚋgraphᚋmodelᚐTodoInput(ctx, tmp)
	}
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Todos(rctx, fc.Args["input"].(*model.TodoInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Todo_user(ctx context.Context, field graphql.CollectedField, obj *model.Todo) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖexamplesᚋgqlgenᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalOTodoInput2ᚖexamplesᚋgqlgenᚋgraphᚋmodelᚐTodoInput(ctx context.Context, v any) (*model.TodoInput, error) {
	if v == nil {
		return nil, nil
	}
